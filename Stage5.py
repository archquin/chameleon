              ...
              #          print('a: from 1 to 4')
                     ...
                     #   i=ij#############################################
                        while ij < jk:
                           ...
                           # b = input()
                                ...
                                while j < k:
                                  ...
                                  #  Yellow = yellow
                                    while k <  i:
                                      ...
                                      #  KiJ = 0
                                        ...
                                        while ik < jk:
                                            ...
                                            if  ik == white:
                                                ...
                                                if (OfX == x and OfY == y and OfX == z and OfY == w and ((a == 'M' or c == 'M')  and  b == '¬H') ):#and c == '¬E') ):
                                                 #   print('Somon',Somon)
                                      ...
                                      #      print(Yellow)
                                            k = int(somon)
                                            if (OfX == z and OfY == y and OfX == x) and OfY == w+1 and ((a == 'M' or c == 'M')  and  b == '¬H' and qx3=='E' and Somon == 5)  :
                                              #  print(Somon,'Somon')
                                               # print('Same column (X coordinates)')
                                                ...
                                                plt.imshow(cYellow)
                                                plt.show()
                                            if (OfX == z and OfY == y and OfX == x) and OfY == w-1 and ((a == 'M' or c == 'M') and  b == '¬H' and qx4 =='E' and Somon == 1)  :
                                                print(Somon,'Somon')
                                               # print('Same column (X coordinates)')
                                             #   print(x,'x',y,'y',z,'z',w,'w',i,'i')
                                                print(x,'x',w,'y')
                                   ...
                                   #  
                                    ...
                                    if j == Blue:
                                        ...
                                        if ( OfX == x and OfY == y ) and OfX == z+1  and ((a == 'M' or c == 'M') and  b == '¬H' and qx1 == 'E' and Somon == 5):# and b != '¬E':
                                     #       print('Same row (Y coordinates)')
                                         ...
                                         #   print(x,'x',y,'y',z,'z',w,'w',i,'i')
                                            ...
                                            plt.imshow(cBlue)
                                            plt.show()
                                        elif ( OfX == x and OfY == y ) and  OfX == z-1 and ((a == 'M' or c == 'M') and  b == '¬H' and qx2=='E' and Somon == 1 ):# and b != '¬E':
                                     #       print('Same row (Y coordinates)')
                                            print(Somon,'Somon')
                                         #   print(x,'x',y,'y',z,'z',w,'w',i,'i')
                                            print(z,'x',y,'y')
                            ...
                            #   print('False')
                               ...
                               if ( OfX == x and  OfY == y and OfY != 0 and OfX!=0) and c == 'M' and b !='¬H':
                                  print(x,'x',y+1,'y') ###=='
                                  plt.imshow(cPink)
                                  plt.show()
                                  if b != '¬H':
                                      print(' Enter Value, E , ¬E')
                                      qx4 = input()
                               if ( OfX == x and  OfY == y+1 and OfY != 0 and OfX!=0) and c == 'M' and b !='¬H':
                                  print(x,'x',y,'y') 
                                  plt.imshow(cPink)
                                  plt.show()
                                  if b != '¬H':
                        ...
                        if ji!=j:
                            ...
                            if OfX == x and OfY != 0 and OfX!=0 and c == 'M' and b !='¬H':
                                print(x+1,'x',OfY,'y')
                                plt.imshow(cGreen)
                                plt.show()
                                if b != '¬H':
                               ...
                               # if c == '¬M':
                                  ##  a = 'M'
                            if  OfX == x+1 and OfY != 0 and OfX!=0 and c == 'M' and b !='¬H':
                                print(x,'x',OfY,'y')
                                plt.imshow(cGreen)
                                plt.show()
                              #  if c == '¬M':
                    ...
                    if b == 'H' and c=='M': 
                        ...
                        qx1=qx2=qx3=qx4=0
                        if b == '¬H':
                            print(' Enter a Value () to change c , [M] V [¬M]')
                            c = input()
                        elif b == 'H':
                            print(' Enter a Value () to change a , [M] V [¬M]')
                            a = input()
