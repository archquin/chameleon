              ...
              #          print('a: from 1 to 4')
                     ...
                     #   i=ij#############################################
                        while ij < jk:
                           ...
                           # b = input()
                                ...
                                while j < k:
                                  ...
                                  #  Yellow = yellow
                                    while k <  i:
                                        ...
                                        while ik < jk:
                                            ...
                                            if  ik == white:
                                              ...
                                              #          q1 = '¬E'
                                                   #     a == 'M'
                                                       # Fs.append(FS)
                                                    elif Nn==2 and c2 == '¬M'  and Somon == 4 :
                                                      #  print(x+1,'x',y-1,'y')
                                                        print(z+1,'ix',w-1,'iy')
                                                        FS=[x+1,y-1]
                                                        plt.imshow(cWhite)
                                          ...
                                          #              q2 = '¬E'
                                                    #    a == 'M'
                                                     #   Fs.append(FS)
                                                    elif Nn==3  and c3 == '¬M'  and Somon == 3 :
                                                      #  print(x-1,'x',y-1,'y')
                                                        print(z-1,'ix',w-1,'iy')
                                                        FS=[x-1,y-1]
                                                        plt.imshow(cWhite)
                                                  ...
                                                  #      a == 'M'
                                                    #    Fs.append(FS)Somon
                                                    elif Nn==4  and c4 == '¬M' and Somon == 2 :
                                                      #  print(x-1,'x',y+1,'y')   
                                                        print(z-1,'ix',w+1,'iy')
                                                        FS=[x-1,y+1]
                                                        plt.imshow(cWhite)
                                      ...
                                      #      print(Yellow)
                                            k = int(somon)
                                            if (OfX == z and OfY == y and OfX == x) and OfY == w+1 and ((a == 'M' or c == 'M')  and  cx2 == '¬M' and b !='¬H' and d!='M' and Somon == 5)  :
                                              #  print(Somon,'Somon')
                                               # print('Same column (X coordinates)')
                                                ...
                                                plt.show()
                                            #    qx3 = '¬E'
                                            if (OfX == z and OfY == y and OfX == x) and OfY == w-1 and ((a == 'M' or c == 'M') and cx1 == '¬M' and b !='¬H' and d!='M' and Somon == 1)  :
                                                print(Somon,'Somon')
                                               # print('Same column (X coordinates)')
                                             #   print(x,'x',y,'y',z,'z',w,'w',i,'i')
                                                print(x,'x',w,'y')
                                   ...
                                   #  
                                    ...
                                    if j == Blue or c != 'M':
                                        ...
                                        if ( OfX == x and OfY == y ) and OfX == z+1  and ((a == 'M' or c == 'M') and  cy2 == '¬M' and b !='¬H' and d!='M' and Somon == 5):# and b != '¬E':
                                     #       print('Same row (Y coordinates)')
                                         ...
                                         #   print(x,'x',y,'y',z,'z',w,'w',i,'i')
                                            ...
                                            plt.show()
                                         #   qx1 = '¬E'
                                        elif ( OfX == x and OfY == y ) and  OfX == z-1 and ((a == 'M' or c == 'M') and cy1 == '¬M' and b !='¬H' and d!='M' and Somon == 1 ):# and b != '¬E':
                                     #       print('Same row (Y coordinates)')
                                            print(Somon,'Somon')
                                         #   print(x,'x',y,'y',z,'z',w,'w',i,'i')
                                            print(z,'x',y,'y')
                            ...
                            #   print('False')
                               ...
                               if ( OfX == x and  OfY == y and OfY != 0 and OfX!=0) and cx1 == 'M' and b !='¬H'  and c == 'M' and d!='M':
                                  print(x,'x',y+1,'y') ###=='
                                  plt.imshow(cPink)
                                  plt.show()
                              #    cx2 = '¬M'
                               #   if b != '¬H':
                                    #  print(' Enter Value, E , ¬E')
                                  #    qx4 = input()
                               if ( OfX == x and  OfY == y+1 and OfY != 0 and OfX!=0) and cx2 == 'M' and b !='¬H'  and c == 'M' and d!='M':
                                  print(x,'x',y,'y') 
                                  plt.imshow(cPink)
                                  plt.show()
                                #  cx1 = '¬M'
                        ...
                        if ji!=j:
                            ...
                            if OfX == x and OfY != 0 and OfX!=0 and cy1 == 'M' and b !='¬H' and c == 'M' and d!='M':
                                print(x+1,'x',OfY,'y')
                                plt.imshow(cGreen)
                                plt.show()
                              #  cy1 = '¬M'
                            ...
                            if  OfX == x+1 and OfY != 0 and OfX!=0 and cy2 == 'M' and b !='¬H'  and c == 'M' and d!='M':
                                print(x,'x',OfY,'y')
                                plt.imshow(cGreen)
                                plt.show()
                               # cy2 = '¬M'
