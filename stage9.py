              ...
              #          print('a: from 1 to 4')
                     ...
                     #   i=ij#############################################
                        while ij < jk:
                           ...
                           # b = input()
                              ...
                              #  j = 5
                                ...
                                while j < k:
                                  ...
                                  #  Yellow = yellow
                                    while k <  i:
                                      ...
                                      #  KiJ = 0
                                        ...
                                        while ik < jk:
                                            ...
                                            if  ik == white:
                                                ...
                                                if (OfX == x and OfY == y and OfX == z and OfY == w and ((a == 'M' or c == 'M')  and  b !='¬H' and d!='M' and f == 'H') ):#and c == '¬E') ):
                                                 #   print('Somon',Somon)
                                                    if Nn == 1 and c1 == 'M'   :
                                                    #    print(x+1,'x',y+1,'y')
                                                     #   print(z+1,'ix',w+1,'iy')
                                      ...
                                      #      print(Yellow)
                                            k = int(somon)
                                            if (OfX == z and OfY == y and OfX == x) and OfY == w+1 and ((a == 'M' or c == 'M')  and  cx2 == 'M' and b !='¬H' and d!='M' and f == 'H'):# and Somon == 5)  :
                                              #  print(Somon,'Somon')
                                               # print('Same column (X coordinates)')
                                                ...
                                                plt.show()
                                            #    qx3 = '¬E'
                                            if (OfX == z and OfY == y and OfX == x) and OfY == w-1 and ((a == 'M' or c == 'M') and cx1 == 'M' and b !='¬H' and d!='M' and f == 'H'):# and Somon == 1)  :
                                                print(Somon,'Somon')
                                               # print('Same column (X coordinates)')
                                             #   print(x,'x',y,'y',z,'z',w,'w',i,'i')
                                                print(x,'x',w,'y')
                                   ...
                                   #  
                                    ...
                                    if j == Blue or c != 'M':
                                        ...
                                        if ( OfX == x and OfY == y ) and OfX == z+1  and ((a == 'M' or c == 'M') and  cy2 == 'M' and b !='¬H' and d!='M' and f == 'H'):#and Somon == 5):# and b != '¬E':
                                     #       print('Same row (Y coordinates)')
                                         ...
                                         #   print(x,'x',y,'y',z,'z',w,'w',i,'i')
                                            ...
                                            plt.show()
                                         #   qx1 = '¬E'
                                        elif ( OfX == x and OfY == y ) and  OfX == z-1 and ((a == 'M' or c == 'M') and cy1 == 'M' and b !='¬H' and d!='M' and f == 'H'):# and Somon == 1 ):# and b != '¬E':
                                     #       print('Same row (Y coordinates)')
                                            print(Somon,'Somon')
                                         #   print(x,'x',y,'y',z,'z',w,'w',i,'i')
                                            print(z,'x',y,'y')
                                ...
                                if k != i :
                                   ...
                                   if  b != '¬H' and c == 'M' and d!='M' and f != 'H':
                                          ...
                                          # print(f,'f')
                                           black = -2
                                   elif  b != '¬H' and c == 'M' and d!='M' and f == 'H':
                                           a = 'M'
                                         #  print(f,'f')
                                           black = -1           
                                ...
                                if k == i :
                                    if ( OfX == x and OfY == y and (a != '¬M' and (a!='M' or b != '¬H')) and c == 'M' and f != 'H') :
                                       FS=[x,y,(a)]
                            ...
                            #   print('False')
                               ...
                               if ( OfX == x and  OfY == y and OfY != 0 and OfX!=0) and cx1 == 'M' and b !='¬H'  and c == 'M' and d!='M' and f != 'H':
                               ...
                               if ( OfX == x and  OfY == y+1 and OfY != 0 and OfX!=0) and cx2 == 'M' and b !='¬H'  and c == 'M' and d!='M' and f != 'H':
                                  print(x,'x',y,'y') 
                                  plt.imshow(cPink)
                                  plt.show()
                                  cc2=(x,y)
                        ...
                        if ji!=j:
                            ...
                            if OfX == x and OfY != 0 and OfX!=0 and cy1 == 'M' and b !='¬H' and c == 'M' and d!='M' and f != 'H':
                            ...
                            if  OfX == x+1 and OfY != 0 and OfX!=0 and cy2 == 'M' and b !='¬H'  and c == 'M' and d!='M' and f != 'H':
                                print(x,'x',OfY,'y')
                                plt.imshow(cGreen)
                                plt.show()
                                cc1 = (x,OfY)
                    ...
                    #j = ij
                    Green = int(green)
                    if  OfY != 0 and OfX!=0 and  b !='¬H'  and c == 'M' and d!='M' :#and f == 'H':      
