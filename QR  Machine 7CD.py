                                ...
                                while j < k:
                                  ...
                                  #  Yellow = yellow
                                        ...
                                        #        plt.show()
                                          #      if ik == jk:
                                            ...
                                            if  ik == white:
                                                ...
                                                if (OfX == x and OfY == y and OfX == z and OfY == w):
                                    ...
                                    #    print(w,'w')
                                      ...
                                      #      print(Yellow)
                                            k = 5
                                            if (OfX == z and OfY == y and OfX == x) and (OfY == w+1 or OfY == w-1):
                              ...
                              #      print(i,j,k)
                                   ...
                                   #  
                                    ...
                                    if j == Blue:
                                     ...
                                     #   print(z,'x',w,'y')
                                        if ( OfX == x and OfY == y ) and (OfX == z+1 or  OfX == z-1) :
                                ...
                                if k != i:
                                   i -= 1
                                   if ( OfX == x and OfY == y and (a != 'M'or a!='T') ):
                                  #     print('x,y is')
                                       print(z,'z',i,'i')
                                       print(x,y)
                                       if c == b:
                                ...
                                if k == i:
                                 ...
                                 #      print('True')
                                   ...
                                   if ( OfX == x and OfY == y and (a != 'M' and a!='T') ) :
                                      # FS=[x,y]
                                     #  Fs.append(FS)
                                       c = b
                                       plt.imshow(ggreyy)
